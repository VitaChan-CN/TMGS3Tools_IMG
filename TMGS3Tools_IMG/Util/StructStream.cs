...
namespace TMGS3Tools_IMG.Util
{
    ...
    public class Unicode16LEString : Attribute { }
    /// <summary>
    /// Ignore Struct Field
    /// </summary>
    ...
    public class Const
    {
        ...
        //Attributes
        public const string UNICODE16LESTRING = "Unicode16LEString";
    ...
    public class StructWriter : BinaryWriter
    {
        ...
        internal void WriteField(dynamic Value, string Type, FieldInfo field, ref object Instance)
        {
            ...
            {
                case Const.STRING:
                    if (HasAttribute(field, Const.UNICODE16LESTRING))
                    {
                        Write(Value, StringStyle.Unicode16LEString);
                        break;
                    }
